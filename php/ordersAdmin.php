						...
						<div class="card-body">
							<div class="table-responsive">
								<table width="100%">
									...
									<tbody>
										<tr>
											<form action="../include/booking.inc.php" method="post" autocomplete="off">
												<td>
												...
												<td>
													<select id="boo_status" name="boo_status">
														<option value="volvo">Approved</option>
														<option value="saab">Denied</option>
													</select>
												</td>
				...
				<div class="orders">
					<div class="card">
						<div class="card-header">
							...
							echo '<h3>' . $row[0] . ' booking found</h3>';
							...
							<div class="table-responsive">
								<table width="100%">
									...
									while ($row = mysqli_fetch_assoc($result)) {
										dispOrders($row['boo_id'], $row['equ_name'], $row['serialNum'], $row['name'], $row['gua_name'], $row['bookDate'], $row['returnDate'], $row['approvedDate'], $row['boo_status']);
									}
