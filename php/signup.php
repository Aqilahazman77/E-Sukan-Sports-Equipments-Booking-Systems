...
<body>
    ...
    <nav class="nav bd-container">
      ...
      <div class="nav__menu" id="nav-menu">
        <ul class="nav__list">
          ...
          <div class="nav__item">
            <a href="./signup.php" class="nav__link active">Sign Up</a>
          </div>
          <div class="nav__item">
  ...
  <div class="login">
    <div class="login__header">
      <h1>WELCOME!</h1>
      <span>TO 7 ECOMMERCE SYSTEM</span>
    </div>
    ...
    <div class="login__content">
      ...
      <div class="login__forms">
        ...
        <!-- ===== SIGN UP ===== -->
        <form action="../include/signup.inc.php" class="login__create" method="post" autocomplete="off">
          <h1 class="login__title">Create Account</h1>

          <div class="login__box">
            <i class="bx bx-user login__icon"></i>
            <input type="name" placeholder="Full Name" class="login__input" name="name" />
          </div>

          <div class="login__box">
            <i class="bx bx-user login__icon"></i>
            <input type="phone" placeholder="Phone number" class="login__input" name="phone" />
          </div>

          <div class="login__box">
            <i class="bx bx-user login__icon"></i>
            <input type="faculty" placeholder="Faculty" class="login__input" name="faculty" />
          </div>
          ...
          <div class="login__box">
            <i class="bx bx-user login__icon"></i>
            <input type="username" placeholder="Username" class="login__input" name="username" />
          </div>
          ...
          <div>
            ...
            <a href="login.php" class="login__signup">Log In</a>
          </div>
        </form>
      </div>
    </div>
